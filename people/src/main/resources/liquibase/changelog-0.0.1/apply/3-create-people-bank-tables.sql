...
IS
  ...
  CREATE TABLE PER_BANK_ACCOUNT
    (
      ...
      NUMBER_ACCOUNT                VARCHAR2 (200 CHAR) NOT NULL ,
...
IS
  ...
  ALTER TABLE PER_BANK_CARD ADD CONSTRAINT PER_BANK_CARD_FK1 FOREIGN KEY ( ID_BANK ) REFERENCES PER_BANCO ( ID_BANCO ) NOT DEFERRABLE ;

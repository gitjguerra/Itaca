...
IS
  ...
  COMMENT ON COLUMN PER_CLASIFICATION_ACCOUNT.ID_CLASIFICATION_ACCOUNT
IS
  'Clave primaria' ;
  COMMENT ON COLUMN PER_CLASIFICATION_ACCOUNT.VALUE_CLASIFICATION_ACCOUNT
IS
  'Descripción multiidioma' ;
  ALTER TABLE PER_CLASIFICATION_ACCOUNT ADD CONSTRAINT PER_CLASIFICATION_ACCOUNT_PK PRIMARY KEY ( ID_CLASIFICATION_ACCOUNT ) ;
...
IS
  'Detalle persona' ;
  COMMENT ON COLUMN PER_BANK_ACCOUNT.ID_CLASIFICATION_ACCOUNT
IS
...
ALTER TABLE PER_BANK_ACCOUNT ADD CONSTRAINT PER_BANK_ACCOUNT_FK2 FOREIGN KEY ( ID_CLASIFICATION_ACCOUNT ) REFERENCES PER_CLASIFICATION_ACCOUNT ( ID_CLASIFICATION_ACCOUNT ) NOT DEFERRABLE ;
...
IS
  ...
  ALTER TABLE PER_BANK_CARD ADD CONSTRAINT PER_BANK_CARD_FK3 FOREIGN KEY ( ID_PERSON_DETAIL ) REFERENCES PER_PERSON_DETAIL ( PERSON_DETAIL_ID ) NOT DEFERRABLE ;

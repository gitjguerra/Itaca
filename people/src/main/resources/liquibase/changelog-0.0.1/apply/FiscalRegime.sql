CREATE TABLE PER_FISCAL_REGIME
  (
    ANNUITY             NUMBER (4),
    EFFECT_DATE          DATE,
    ID_FISCAL_REGIME NUMBER (19) NOT NULL,
    PERSON_DETAIL_ID        NUMBER (19) NOT NULL,
    ID_FISCAL_REGIME_AMOUNTS NUMBER (19) NOT NULL
...
TABLESPACE ITACA_INDEX LOGGING ;

ALTER TABLE PER_FISCAL_REGIME ADD CONSTRAINT PER_FISCAL_REGIME_PK PRIMARY KEY ( ID_FISCAL_REGIME ) ;
...
ALTER TABLE PER_FISCAL_REGIME ADD CONSTRAINT PER_FISCAL_REGIME_FK2 FOREIGN KEY ( ID_FISCAL_REGIME_AMOUNTS ) REFERENCES FIS_FISCAL_REGIME_AMOUNTS ( ID_FISCAL_REGIME_AMOUNTS ) ;
...
Insert into LD_LOAD_ATOMIC_OPERATION (LOAD_ATOMIC_OPERATION_ID,LOAD_OPERATION_TYPE_ID,ATOMIC_OP_CODE,NAME,DESCRIPTION) values ('1','1','0','Insert','Atomic insert into definitve table')

/

Insert into LD_LOAD_ATOMIC_OPERATION (LOAD_ATOMIC_OPERATION_ID,LOAD_OPERATION_TYPE_ID,ATOMIC_OP_CODE,NAME,DESCRIPTION) values ('2','1','1','Update','Atomic update record in definitve table')

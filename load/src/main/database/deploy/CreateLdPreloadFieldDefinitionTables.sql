...
COMMENT ON COLUMN LD_PRELOAD_FIELD_DEFINITION.REL_TYPE IS '0 No mapping, 1 Load schema, 2 Database table,3 Search in both';
...
COMMENT ON COLUMN LD_PRELOAD_FIELD_DEFINITION.ERROR_SEVERITY IS '1 Low, 2 Medium, 3 High';
...
ALTER TABLE LD_PRELOAD_FIELD_DEFINITION ADD (CONSTRAINT COLUMN_UNIQUE UNIQUE (PRELOAD_ROW_TYPE_ID, COLUMN_NO) ENABLE VALIDATE);
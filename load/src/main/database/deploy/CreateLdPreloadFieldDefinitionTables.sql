...
ALTER TABLE LD_PRELOAD_FIELD_DEFINITION ADD (CONSTRAINT FK_PRELOADFIELDTYPEID FOREIGN KEY (PRELOAD_FIELD_TYPE_ID) REFERENCES LD_PRELOAD_FIELD_TYPE (PRELOAD_FIELD_TYPE_ID)  ENABLE VALIDATE,  CONSTRAINT FK_PRELOADROWTYPEID FOREIGN KEY (PRELOAD_ROW_TYPE_ID) REFERENCES LD_PRELOAD_ROW_TYPE (PRELOAD_ROW_TYPE_ID) ENABLE VALIDATE);
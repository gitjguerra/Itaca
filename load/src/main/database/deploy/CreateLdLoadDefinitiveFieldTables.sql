...
(
	LOAD_DEFINITIVE_FIELD_ID NUMBER not null
		primary key,
...
ALTER TABLE LD_LOAD_DEFINITIVE_FIELD ADD CONSTRAINT LD_LOAD_DEFINITIVE_FIELD_FK1 FOREIGN KEY ( LOAD_DEFINITIVE_FIELD_ID ) REFERENCES LD_LOAD_DEFINITIVE_TABLE ( LOAD_DEFINITIVE_TABLE_ID ) NOT DEFERRABLE
